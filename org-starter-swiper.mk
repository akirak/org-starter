...
ELPA_DEPENDENCIES=package-lint org-starter swiper
...
LINT_CHECKDOC_FILES=org-starter-swiper.el

# List of files to check for packaging guidelines:
LINT_PACKAGE_LINT_FILES=org-starter-swiper.el

# List of files to check for compilation errors and warnings:
LINT_COMPILE_FILES=org-starter-swiper.el
